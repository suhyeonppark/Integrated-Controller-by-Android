...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  /// Working copy of the Wake-on-LAN PC list, committed on save.
  ...
  /// Editable list of Wake-on-LAN PCs. Changes are applied on "설정 저장".
  Widget _pcSection() {
    return Column(
  ...
  /// Add a new PC or edit [existing] via a dialog. Updates [_pcs] on confirm.
